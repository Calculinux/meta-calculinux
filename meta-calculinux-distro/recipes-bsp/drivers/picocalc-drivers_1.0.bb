...
FILES:${PN}-lcd = "${nonarch_base_libdir}/modules/${KERNEL_VERSION}/extra/ili9488.ko"
...
do_install() {
    ...
    install -m 0644 ${S}/picocalc_lcd/ili9488.ko ${D}${nonarch_base_libdir}/modules/${KERNEL_VERSION}/extra/

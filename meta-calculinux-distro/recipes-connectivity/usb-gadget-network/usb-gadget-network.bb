...
SRC_URI = " \
    ...
    file://usb-gadget-serial-console.sh \
    file://usb-gadget-serial-console.service \
    file://README.md \
"

inherit systemd

SYSTEMD_SERVICE:${PN} = "usb-gadget-network.service usb-gadget-serial-console.service"
